...
inline ::epoch_proto::DashStyle Line::dash_style() const {
  // @@protoc_insertion_point(field_get:epoch_proto.Line.dash_style)
  return _internal_dash_style();
}
inline void Line::set_dash_style(::epoch_proto::DashStyle value) {
  _internal_set_dash_style(value);
  _impl_._has_bits_[0] |= 0x00000001u;
  // @@protoc_insertion_point(field_set:epoch_proto.Line.dash_style)
}
inline ::epoch_proto::DashStyle Line::_internal_dash_style() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return static_cast<::epoch_proto::DashStyle>(_impl_.dash_style_);
}
inline void Line::_internal_set_dash_style(::epoch_proto::DashStyle value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
// bool vertical = 5;
inline void BarDef::clear_vertical() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.vertical_ = false;
}
inline bool BarDef::vertical() const {
  // @@protoc_insertion_point(field_get:epoch_proto.BarDef.vertical)
  return _internal_vertical();
}
inline void BarDef::set_vertical(bool value) {
  _internal_set_vertical(value);
  // @@protoc_insertion_point(field_set:epoch_proto.BarDef.vertical)
}
inline bool BarDef::_internal_vertical() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.vertical_;
}
