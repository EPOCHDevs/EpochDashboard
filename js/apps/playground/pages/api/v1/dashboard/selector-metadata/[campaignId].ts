...
export default async function handler(
  ...
  try {
    const targetUrl = `${backendUrl}/api/v1/dashboard/selector-metadata/${campaignId}`
    console.log(`[Proxy] Fetching selector metadata from: ${targetUrl}`)
